...
def check_network_socket(ip)
    default_http_service = check_for_docker_network_socket("http://#{ip}", 2375)
    default_https_service = check_for_docker_network_socket("https://#{ip}", 2376)
...
def check_for_docker_network_socket(path, port)
    begin
